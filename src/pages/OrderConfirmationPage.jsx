...
const OrderConfirmationPage = () => {
  ...
  const { currentCheckout: checkout, currentCheckoutLoading: loading, currentCheckoutError: error } = useSelector((state) => state.checkout);
      ...
      <div className="p-6 rounded-lg border bg-gray-50">
        ...
        <div className="my-6 space-y-4">
          {checkout.items.map((item) => (
            <div key={`${item.product._id}-${item.color}-${item.material}`} className="flex items-center gap-4">
              <img
        ...
        <div className="mt-8 border-t pt-6">
            ...
            <div className="text-gray-600">
              ...
              <p>{checkout.shippingAddress.city}, {checkout.shippingAddress.postalCode}</p>
